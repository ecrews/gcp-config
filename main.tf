...
resource "google_container_cluster" "flux" {
  name     = "flux"
  location = var.region
...
resource "google_container_node_pool" "argocd_preemptible_nodes" {
  name       = "primary"
  location   = var.region
...
resource "google_container_node_pool" "flux_preemptible_nodes" {
  name       = "primary"
  location   = var.region
  cluster    = google_container_cluster.flux.name
  node_count = var.node_pool.node_count
